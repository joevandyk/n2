N2::Application.routes.draw do
  ...
  resources :users do
    collection do
  get :dont_ask_me_invite_friends
  get :dont_ask_me_for_email
  get :current
  post :current
  ...
  match '/cards/received/:card_id/from/:user_id.:format' => 'cards#received', :as => :received_card
  match '/' => 'home#index'
  ...
  namespace :admin do
      ...
      match '/featured_items/:id/load_items/page/:page' => 'featured_items#load_items', :as => :paged_items
  ...
  match '/m' => 'mobile/home#index', :as => :mobile_home
  resources :stories
  resources :comments
